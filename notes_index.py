...
class NotesBufferCommand(sublime_plugin.WindowCommand):
    def run(self):
        ...
        view.set_syntax_file('Packages/JustNotes/Languages/Notes Index.hidden-tmLanguage')
        view.settings().set('color_scheme', 'Packages/JustNotes/Color Schemes/Notes-Index.hidden-tmTheme')
